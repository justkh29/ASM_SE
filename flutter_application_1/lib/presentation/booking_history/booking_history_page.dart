...
//     // Tạo chuỗi hiển thị cả tên và email
...
//               _buildInfoRow('Người đặt:', userDisplay), // Hiển thị cả tên và email
//             ],
//           ),
//         ),
//         actions: [
...
//     if (confirmed == true) {
//       final result = await sl<BookingRepository>().deleteBooking(booking);
//       result.fold(
//         (error) {
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(
//               content: Text('Lỗi khi hủy đặt phòng: $error'),
//               backgroundColor: Colors.red,
//             ),
//           );
//         },
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              if (booking.status != 'pending') // Ẩn mã nếu trạng thái là pending
