...
class _RoomManagementPageState extends State<RoomManagementPage> {
  ...
  Future<void> _confirmBooking(BookingRequest booking) async {
    ...
    final checkInCode = _generateCheckInCode(); // Tạo mã nhận phòng 1 lần khi xác nhận
    ...
    final updatedBooking = BookingRequest(
      ...
      status: 'confirmed',
      checkInCode: checkInCode, // Lưu mã nhận phòng vào booking
    );
  ...
  Future<void> _extendBooking(BookingRequest booking) async {
    ...
    final updatedBooking = BookingRequest(
      ...
      checkInCode: booking.checkInCode, // Giữ nguyên mã nhận phòng
    );
